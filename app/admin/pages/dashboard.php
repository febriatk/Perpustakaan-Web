...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="alert alert-secondary" style="color: #383d41; background-color: #e2e3e5; border-color: #d6d8db;">
            Selamat Datang, <?= $_SESSION['nama']; ?> di Administrator Website Book Cafe & Library
        </div>
        ...
        <div class="row">
            ...
            <?php
            include "../../config/koneksi.php";
            $query = mysqli_query($koneksi, "SELECT * FROM identitas_perpus");
            $row = mysqli_fetch_assoc($query);

            ?>

            <img src="../../assets/image/bookcafe.png" width="120px" height="120px" style="display: block; margin-left: auto; margin-right: auto; margin-top: 30px; margin-bottom: -20px;">

            <h2 class="text-center" style="font-family: Quicksand, sans-serif;"><?= $row['nama_perpus']; ?></h2>
            <p class="text-center">Alamat : <?=$row['alamat_perpus']; ?></p>
