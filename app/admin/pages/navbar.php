<header class="main-header">
    ...
    <a href="dashboard" class="logo" style="font-family: 'Quicksand', sans-serif">
        ...
        $sql = mysqli_query($koneksi, "SELECT * FROM identitas_perpus");
        $row = mysqli_fetch_assoc($sql);
        ?>
        <span class="logo-lg"><b>BOOK CAFE & LIBRARY</b> <i class="fa fa-book"></i></span>
    </a>
            ...
            <ul class="nav navbar-nav">
                                    ...
                                    <li>
                                        ...
                                        <a href="lihat-pesan?id_pesan=<?= $row_pesan1['id_pesan']; ?>">
                                            ...
                                            <h4 style="font-family: 'Quicksand', sans-serif">
                                                ...
                                                $query_cek_verif = mysqli_query($koneksi, "SELECT * FROM akun WHERE nama = '$nama'");
                ...
                <li class="dropdown notifications-menu">
                    <a style="cursor: pointer;" class="dropdown-toggle" data-toggle="dropdown" id="badgeNotif">
                        ...
                        $default = "Belum dibaca";
                        $query_notif2 = mysqli_query($koneksi, "SELECT * FROM pemberitahuan WHERE level_akun = '$level_user' AND status = '$default'");
                        ...
                        $level_user = $_SESSION['level'];
                        $default = "Belum dibaca";
                        $query_notif1 = mysqli_query($koneksi, "SELECT * FROM pemberitahuan WHERE level_akun = '$level_user' AND status = '$default'");
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            ...
                            <ul class="menu" id="isiNotif">
                                <?php
                                include "../../config/koneksi.php";
                                $query_isi_notif = mysqli_query($koneksi, "SELECT * FROM pemberitahuan WHERE level_akun = '$level_user' AND status = '$default'");
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs"><?= $_SESSION['nama']; ?>
                            <?php include "../../config/koneksi.php";
                            $id = $_SESSION['id_akun'];
                            $query_verif = mysqli_query($koneksi, "SELECT * FROM akun WHERE id_akun = '$id'");
