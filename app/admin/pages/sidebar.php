<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="daftar-anggota"><i class="fa fa-folder"></i> <span>Daftar Anggota</span></a></li>
            <li><a href="koleksi-buku"><i class="fa fa-book"></i> <span>Koleksi Buku</span></a></li>
            <li><a href="konfirmasi-pembayaran"><i class="fa fa-money"></i> <span>Konfirmasi Pembayaran</span></a></li>
            <li><a href="data-pinjam-buku"><i class="fa fa-book"></i> <span>Data Peminjaman Buku</span></a></li>
            <li><a href="pesan-buku"><i class="fa fa-book"></i> <span>Data Pemesanan Buku</span></a></li>
            <li><a href="daftar-admin"><i class="fa fa-folder"></i> <span>Daftar Admin</span></a></li>
